<?php
	...
	if($vw_healthcare_first_color != false){
		$vw_healthcare_custom_css .='.topbar-btn a:hover,.more-btn a:hover,input[type="submit"]:hover,#comments input[type="submit"]:hover,#comments a.comment-reply-link:hover,#slider .carousel-control-prev-icon:hover, #slider .carousel-control-next-icon:hover,.pagination .current,.pagination a:hover,#footer .tagcloud a:hover,#sidebar .tagcloud a:hover,.woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover,.woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover,.widget_product_search button:hover,nav.woocommerce-MyAccount-navigation ul li:hover, nav.navigation.posts-navigation .nav-previous a:hover, nav.navigation.posts-navigation .nav-next a:hover,.wp-block-woocommerce-empty-cart-block span.woocommerce-Price-amount.amount{';
			$vw_healthcare_custom_css .='color: '.esc_attr($vw_healthcare_first_color).'!important;';
		$vw_healthcare_custom_css .='}';
	}

	if($vw_healthcare_first_color != false){
		$vw_healthcare_custom_css .='.entry-content .wp-block-button__link,.middle-bar{';
			$vw_healthcare_custom_css .='border-color: '.esc_attr($vw_healthcare_first_color).'!important;';
		$vw_healthcare_custom_css .='}';
	}
	...
	if($vw_healthcare_second_color != false){
		$vw_healthcare_custom_css .='#footer .textwidget a,#footer li a:hover,.post-main-box:hover h3 a,#sidebar ul li a:hover,.post-navigation a:hover .post-title, .post-navigation a:focus .post-title,.post-navigation a:hover,.post-navigation a:focus, .copyright a:hover, .logo h1 a:hover, .logo p.site-title a:hover, .middle-bar h6 a:hover, .slider-inner-box h1 a:hover, .post-main-box:hover h2 a, .post-main-box:hover .post-info a, .single-post .post-info:hover a,.wp-block-woocommerce-cart .wc-block-cart__submit-button:hover, .wc-block-components-checkout-place-order-button:hover, .wp-block-woocommerce-empty-cart-block a.wp-block-button__link.add_to_cart_button.ajax_add_to_cart:hover,.search-box i,a, .main-navigation a:hover{';
			$vw_healthcare_custom_css .='color: '.esc_attr($vw_healthcare_second_color).'!important;';
		$vw_healthcare_custom_css .='}';
	}

	if($vw_healthcare_second_color != false){
		$vw_healthcare_custom_css .='.middle-bar i,.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale{';
	...
	if($vw_healthcare_footer_background_image != false){
		$vw_healthcare_custom_css .='#footer{';
			$vw_healthcare_custom_css .='background: url('.esc_attr($vw_healthcare_footer_background_image).');background-size:cover;';
		$vw_healthcare_custom_css .='}';
	}
	...
	$vw_healthcare_theme_lay = get_theme_mod( 'vw_healthcare_footer_template','vw_healthcare-footer-one');
    if($vw_healthcare_theme_lay == 'vw_healthcare-footer-one'){
		$vw_healthcare_custom_css .='#footer{';
			$vw_healthcare_custom_css .='';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer ul li{';
			$vw_healthcare_custom_css .='color:#fff;';
		$vw_healthcare_custom_css .='}';

	}else if($vw_healthcare_theme_lay == 'vw_healthcare-footer-two'){
		$vw_healthcare_custom_css .='#footer{';
			$vw_healthcare_custom_css .='background: linear-gradient(to right, #f9f8ff, #dedafa);';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field,#footer ul li{';
			$vw_healthcare_custom_css .='color:#000;';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer ul li::before{';
			$vw_healthcare_custom_css .='background:#000;';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer table, #footer th, #footer td,#footer .search-form .search-field,#footer .tagcloud a{';
			$vw_healthcare_custom_css .='border: 1px solid #000;';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer ul li{';
			$vw_healthcare_custom_css .='border-bottom: 1px solid #000;';
		$vw_healthcare_custom_css .='}';

	}else if($vw_healthcare_theme_lay == 'vw_healthcare-footer-three'){
		$vw_healthcare_custom_css .='#footer{';
			$vw_healthcare_custom_css .='background: #232524;';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer ul li{';
			$vw_healthcare_custom_css .='color: #fff;';
		$vw_healthcare_custom_css .='}';
	}
	else if($vw_healthcare_theme_lay == 'vw_healthcare-footer-four'){
		$vw_healthcare_custom_css .='#footer{';
			$vw_healthcare_custom_css .='background: #f7f7f7;';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field,#footer ul li{';
			$vw_healthcare_custom_css .='color:#000;';
		$vw_healthcare_custom_css .='}';
	...
	else if($vw_healthcare_theme_lay == 'vw_healthcare-footer-five'){
		$vw_healthcare_custom_css .='#footer{';
			$vw_healthcare_custom_css .='background: linear-gradient(to right, #01093a, #2d0b00);';
		$vw_healthcare_custom_css .='}';
		$vw_healthcare_custom_css .='#footer ul li{';
			$vw_healthcare_custom_css .='color: #fff;';
		$vw_healthcare_custom_css .='}';
	...
	$vw_healthcare_button_footer_heading_letter_spacing = get_theme_mod('vw_healthcare_button_footer_heading_letter_spacing',1);
	$vw_healthcare_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
		$vw_healthcare_custom_css .='letter-spacing: '.esc_attr($vw_healthcare_button_footer_heading_letter_spacing).'px;';
	$vw_healthcare_custom_css .='}';

	$vw_healthcare_button_footer_font_size = get_theme_mod('vw_healthcare_button_footer_font_size','30');
	$vw_healthcare_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
		$vw_healthcare_custom_css .='font-size: '.esc_attr($vw_healthcare_button_footer_font_size).'px;';
	$vw_healthcare_custom_css .='}';

	$vw_healthcare_theme_lay = get_theme_mod( 'vw_healthcare_button_footer_text_transform','Capitalize');
	if($vw_healthcare_theme_lay == 'Capitalize'){
		$vw_healthcare_custom_css .='#footer h3{';
			$vw_healthcare_custom_css .='text-transform:Capitalize;';
		$vw_healthcare_custom_css .='}';
	}
	if($vw_healthcare_theme_lay == 'Lowercase'){
	...
	$vw_healthcare_footer_heading_weight = get_theme_mod('vw_healthcare_footer_heading_weight','600');
	if($vw_healthcare_footer_heading_weight != false){
		$vw_healthcare_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
			$vw_healthcare_custom_css .='font-weight: '.esc_attr($vw_healthcare_footer_heading_weight).';';
		$vw_healthcare_custom_css .='}';
	}
