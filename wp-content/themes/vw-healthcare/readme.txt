...
VW Healthcare is a good theme to design professional websites for hospitals, general phycisian, covid care unit, medical clinics, medic center, plastic surgeons, laser treatment centers, dermatologists, dentists, and any health care expert or worker related to the healthcare industry. It is a multipurpose theme that can fit any purpose. The simple and sophisticated layout designed with a minimal approach is the key. This helps to give a clear and stunning display of all your healthcare and medical services. It consists of all the modern features and an SEO-friendly design that gives a better chance to your website to pop up in the higher SERP ranks. WPML and RTL compatibility makes your theme translation ready helping your business to go beyond the language borders. The user-friendly customization options do not need you to write codes while making the changes in the layout.
...
= 0.6.6 =
* Added go pro button in slider, our specialize and footer section in customizer.
...
* Resolved header button problem in customizer.
* Updated language folder.
...
* Added 404 page section in customizer.
* Update language folder.  
...
= 0.7.9 =
* Added social icon setting option in customizer.
* Added css for social icon widgets in sidebar.
* Update language folder.
...
* Resolved error for social icons.

= 0.9.2 =
* Resolved slider arrow css.
* Resolved toggle icon css.
* Resolved slider css in tablet media.

= 0.9.3 =
* Resolved sidebar css issue.
* Added css for calender widgets for footer.
...
* Added search, category and dropdown category sidebar widgets for preview.
* Update pot file.

= 0.9.6 =
* Resolved our specialize section condition.
...
VW Healthcare WordPress Theme, Copyright 2021 VWThemes
VW Healthcare is distributed under the terms of the GNU GPL.
...
== Fonts ==
* Exo+2 *
* Source : https://fonts.google.com/specimen/Exo+2?query=Exo+2

* Pxhere Images,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/license

Slider Image, Copyright turey2018
License: CC0 1.0 Universal (CC0 1.0)
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/917219

Services Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/918240

Services Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1446757

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-healthcare/