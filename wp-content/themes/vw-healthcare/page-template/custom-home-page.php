...
<main id="maincontent" role="main">
              ...
              <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                ...
                <div class="carousel-caption">
                  <div class="slider-inner-box">
                    ...
                    <?php } ?>
                    <?php
                    $vw_healthcare_button_text = get_theme_mod('vw_healthcare_slider_button_text','Read More');
                    $vw_healthcare_button_link = get_theme_mod('vw_healthcare_topbar_btn_link', '');
                    if (empty($vw_healthcare_button_link)) {
                      $vw_healthcare_button_link = get_permalink();
                    }
                    if ($vw_healthcare_button_text || !empty($vw_healthcare_button_link)) { ?>
                      <div class="more-btn my-3 my-lg-4 my-md-4 wow zoomInUp delay-1000" data-wow-duration="3s">
                        <?php if( get_theme_mod('vw_healthcare_slider_button_text','Read More') != ''){ ?>
                          <a href="<?php echo esc_url($vw_healthcare_button_link); ?>" class="p-3">
                          <?php echo esc_html($vw_healthcare_button_text); ?>
                            <span class="screen-reader-text"><?php echo esc_html($vw_healthcare_button_text); ?></span>
                          </a>
                        <?php } ?>
                      </div>
                    <?php }?> 
  ...
  <?php if( get_theme_mod('vw_healthcare_services_category') != ''){ ?>
