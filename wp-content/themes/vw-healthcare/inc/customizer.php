...
function vw_healthcare_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_setting('vw_healthcare_slider_image_overlay_color', array(
    ...
    $wp_customize->add_control( new vw_healthcare_Toggle_Switch_Custom_Control( $wp_customize, 'vw_healthcare_footer_hide_show',array(
 	...
 	// font size
	$wp_customize->add_setting('vw_healthcare_button_footer_font_size',array(
		'default'=> 30,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_healthcare_button_footer_font_size',array(
		'label'	=> __('Footer Heading Font Size','vw-healthcare'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('vw_healthcare_button_footer_heading_letter_spacing',array(
		'default'=> 1,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_healthcare_button_footer_heading_letter_spacing',array(
		'label'	=> __('Heading Letter Spacing','vw-healthcare'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// text trasform
	$wp_customize->add_setting('vw_healthcare_button_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'vw_healthcare_sanitize_choices'
	));
	$wp_customize->add_control('vw_healthcare_button_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','vw-healthcare'),
		'choices' => array(
      'Uppercase' => __('Uppercase','vw-healthcare'),
      'Capitalize' => __('Capitalize','vw-healthcare'),
      'Lowercase' => __('Lowercase','vw-healthcare'),
	...
	$wp_customize->add_setting('vw_healthcare_footer_heading_weight',array(
        'default' => 600,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_healthcare_sanitize_choices'
	));
	$wp_customize->add_control('vw_healthcare_footer_heading_weight',array(
        'type' => 'select',
        'label' => __('Heading Font Weight','vw-healthcare'),
        'section' => 'vw_healthcare_footer',
        'choices' => array(
        	'100' => __('100','vw-healthcare'),
            '200' => __('200','vw-healthcare'),
    ...
    $wp_customize->add_setting('vw_healthcare_footer_template',array(
      'default'	=> esc_html('vw_healthcare-footer-one'),
      'sanitize_callback'	=> 'vw_healthcare_sanitize_choices'	
	  ));
	  $wp_customize->add_control('vw_healthcare_footer_template',array(
	          'label'	=> esc_html__('Footer style','vw-healthcare'),
	          'section'	=> 'vw_healthcare_footer',
	          'setting'	=> 'vw_healthcare_footer_template',
	          'type' => 'select',
	          'choices' => array(
	              'vw_healthcare-footer-one' => esc_html__('Style 1', 'vw-healthcare'),
	              'vw_healthcare-footer-two' => esc_html__('Style 2', 'vw-healthcare'),
	              'vw_healthcare-footer-three' => esc_html__('Style 3', 'vw-healthcare'),
	              'vw_healthcare-footer-four' => esc_html__('Style 4', 'vw-healthcare'),
	              'vw_healthcare-footer-five' => esc_html__('Style 5', 'vw-healthcare'),
	              )
	  ));
